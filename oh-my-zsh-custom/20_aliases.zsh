...
alias stan='docker run --user 1000:1000 -it --rm --memory=8g -v $(pwd):$(pwd) -w $(pwd) spryker/php:7.3 vendor/bin/phpstan analyse --memory-limit=-1'
alias cs='docker run -it --rm --memory=8g -v $(pwd):/app -w /app spryker/php:7.3 vendor/bin/phpcs --standard=config/ruleset.xml'
alias cbf='docker run --user 1000:1000 -it --rm --memory=8g -v $(pwd):/app -w /app spryker/php:7.3 vendor/bin/phpcbf --standard=config/ruleset.xml'
alias gs='gss'
